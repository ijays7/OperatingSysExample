...
import com.ijays.operatonsysexample.widget.CustomProgressbarDrawable;
import com.ijays.operatonsysexample.widget.ImageDownloadListener;


import com.ijays.operatonsysexample.photoview.PhotoViewAttacher.OnMatrixChangedListener;
    ...
    protected void init() {
        ...
        mAttacher.setOnLongClickListener(new OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                showSavePicDialog(view.getContext());
                return false;
            }
        });
    }
